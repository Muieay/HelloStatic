...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('pjax:compvare', translateInitialization);
});
...
$('#menu-backward').unbind('click').on('click', function () { window.history.back(); });
$('#menu-forward').unbind('click').on('click', function () { window.history.forward(); });
$('#menu-refresh').unbind('click').on('click', function () { window.location.reload(); });
$('#menu-darkmode').unbind('click').on('click', function () { switchDarkMode() });

$('#menu-home').unbind('click').on('click', function () { window.location.href = window.location.origin; });
/* 简体繁体切换 */
$('#menu-translate').unbind('click').on('click', function () {
    removeRightMenu();
    translateInitialization();
});
$(".menu-link").unbind('click').on("click", function () {
    removeRightMenu()
});
$("#rightmenu-mask").unbind('click').on("click", function () { removeRightMenu() });
